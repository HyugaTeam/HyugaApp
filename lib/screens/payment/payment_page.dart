...
class PaymentPage extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          child: Icon(Icons.people, color: Theme.of(context).primaryColor, size: 19,),
                          backgroundColor: Theme.of(context).highlightColor, radius: 15,
                        ), 
                        SizedBox(width: 15,),     
                        Text("Număr persoane", style: Theme.of(context).textTheme.labelMedium,),
                      ],
                    ),
                    Container(
                      //width: 100,
                      child: DropdownButton(
                        ...
                        // isExpanded: true,
                        items: provider.listOfNumberOfPeople.map((e) => DropdownMenuItem(
                          value: e,
                          child: Text(
                            e.toString(),
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          child: Icon(Icons.person, color: Theme.of(context).primaryColor, size: 19,),
                          backgroundColor: Theme.of(context).highlightColor, radius: 15,
                        ), 
                        SizedBox(width: 15,),     
                        Text("Nume", style: Theme.of(context).textTheme.labelMedium,),
                      ],
                    ),
                    Container(
                      // height: 100,
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          child: Icon(Icons.email_rounded, color: Theme.of(context).primaryColor, size: 19,),
                          backgroundColor: Theme.of(context).highlightColor, radius: 15,
                        ), 
                        SizedBox(width: 15,),     
                ...
                Row(
                  children: [
                    CircleAvatar(
                      child: Icon(Icons.credit_card, color: Theme.of(context).primaryColor, size: 19,),
                      backgroundColor: Theme.of(context).highlightColor, radius: 15,
                    ), 
                    SizedBox(width: 15,),     
                ...
                MaterialButton(
                  ...
                  : () async{
                    ...
                    if(result == null || result == false){
                      ...
                      if(ticket != null){
                        Navigator.popUntil(context, (route) => route.isFirst);
                        wrapperHomePageProvider.updateSelectedScreenIndex(2);
                        /// Update tickets history
                        if(wrapperHomePageProvider.historyPageProvider != null){
                          wrapperHomePageProvider.historyPageProvider!.getData();
                          if(wrapperHomePageProvider.historyPageProvider!.viewType == ViewType.reservations)
                            wrapperHomePageProvider.historyPageProvider!.changeViewType();
                        }
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>
                          MultiProvider(
                            providers: [
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text("Biletul a fost înregistrat! Mulțumim că ai achiziționat un bilet prin Wine Street!")
                        ));
                      }
                    }
  ...
  _finishPayment(BuildContext context, PaymentPageProvider provider, ){
