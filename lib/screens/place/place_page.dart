...
class _PlacePageState extends State<PlacePage> with TickerProviderStateMixin{
  ...
  Future _openReservationDialog(BuildContext context) async{
    ...
    if(!authService.currentUser!.isAnonymous!){
      if(widget.place!.hasReservations == true){
        ...
        .where('date_start', isGreaterThan: Timestamp.fromDate(DateTime.now().toLocal())).get().then((value){
          ...
          else if(widget.place!.hasReservations == true)
            if(widget.place!.preferPhone == true) {
              dialPhoneNumber(widget.place!.phoneNumber);
            }
            else {
              showGeneralDialog(
                context: context,
                    ...
                    background: Hero(
                      ...
                      child: FutureBuilder<Image>(
                        ...
                        builder: (context,image){
                          if(widget.place!.finalImage == null)
                            return Container(
                              width: 400,
                              height: 200,
                              color: Colors.white,
            ...
            body: Container(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Container( // Name
                            ...
                            child: Text(
                              widget.place!.name==null? 'wrong':widget.place!.name!,
                              maxLines: 2,
                              style: TextStyle(
                      ...
                      Column(
                        children: [
                          DropdownButton( /// 'Select the Day' widget
                            ...
                            onChanged: (dynamic value){
                              setState((){
                                ...
                                if(widget.place!.deals != null)
                                  if(widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()] != null)
                          ...
                          widget.place!.discounts != null && widget.place!.discounts![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()] != null
                          ||
                          widget.place!.deals != null && widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()] != null
                          ? Column(
                            children: [
                              Container(
                              ...
                              Container( /// The list of deals & discounts
                                ...
                                child: ListView.separated(
                                  scrollDirection: Axis.horizontal,
                                  shrinkWrap: true,
                                  itemCount: widget.place!.deals != null ?  
                                            (widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()] != null? 
                                              widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()].length : 0): 
                                            0,
                                  separatorBuilder: (BuildContext context, int index) => SizedBox(width: 20,),
                                  itemBuilder: (context,index) { 
                                    Deal deal = Deal(
                                      title: widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index]['title'], 
                                      content: widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index]['content'], 
                                      interval: widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index]['interval']
                                    );
              ...
              //                         },
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Text(
                                                    widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index]['title'],
                                                    style: TextStyle(
                                                      color: Colors.white,
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  "consumație minimă:\n" 
                                                  +
                                                  (widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index].containsKey('threshold')
                                                  ? widget.place!.deals![kWeekdaysFull.keys.toList()[_selectedWeekday-1].toLowerCase()][index]['threshold']
                                                  : "*click*"),
                      ...
                      Container( // Description text
                        ...
                        child: Text(
                          widget.place!.description==null? 'wrong':widget.place!.description!,
                          style: TextStyle(
                            fontSize: 15,
                          ...
                          Container( 
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () async{
                                ...
                                "&dropoff[nickname]="
                                + widget.place!.name!.replaceAll(' ', '%20') +
                          ...
                          child: Row(
                            ...
                            children: kWeekdaysFull.keys.map((String? key) => Column(
                                children: <Widget>[
                                  ...
                                  Text(
                                    widget.place!.schedule![key!.toLowerCase()].substring(0,5),
                                  ),
                                  Text(
                                    widget.place!.schedule![key.toLowerCase()].substring(6,11),
                                  )
                                ],
                              ),
                            ).toList()
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              RaisedButton(
                                ...
                                onPressed: (){
                                  _launchInBrowser(context, widget.place!.menu!);
                                }
                              ),
                              Container(
                                width: MediaQuery.of(context).size.width*0.3,
                                child: Text(
                                  widget.place!.hasOpenspace == true
                                  ? "Terasa: Da"
                                  : "Terasa: Nu"
                                ),
                              )
